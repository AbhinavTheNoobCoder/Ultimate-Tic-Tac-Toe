...
''')
   ...
   big_board = big_board.replace(player1_move, " X ") if len(player1_move) == 3 else big_board.replace(player1_move, "X ")
   ...
   while True:
      ...
      print(big_board) #print the overall board
      ...
      big_board = big_board.replace(player2_move, " O ") if len(player2_move) == 3 else big_board.replace(player2_move, "O ") #to maintain aesthetic
      ...
      for miniboard in list_of_boards:
         if Winner(dict_of_boards[miniboard]) == "X" or Winner(dict_of_boards[miniboard]) == "O":
            winner = f"Won by {Winner(dict_of_boards[miniboard])}"
